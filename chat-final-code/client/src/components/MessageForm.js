                ...
                {user && privateMemberMsg?._id && (
                    <>
                        <div className="alert alert-info conversation-info">
                            <div>
                                Your conversation with {privateMemberMsg.name} <img src={privateMemberMsg.picture} className="conversation-profile-pic" alt="Profile Preview" />
                            </div>
                        </div>
                    </>
                )}
                ...
                <Grid container>
                    ...
                    <Grid item md={1}>
                        <Button
                            ...
                            color="primary"
                            type="submit"
                            style={{ width: "100%" ,height:"100%",marginLeft:'10px', backgroundColor: "#5F9EA0" }}
                            disabled={!user}
                        >
